(function($) {
	...
	$( document ).ready(function() {
		...
		$( 'body' ).on( 'keyup', '.btKey', function() {
			var key = $( this ).val();
			var hidden_el = $( this ).parent().find( 'input[type="hidden"]' );
			var val_el = $( this ).parent().find( '.btValue' );
		...
		$( 'body' ).on( 'change', '.btKeySelect', function() {
			var hidden_el = $( this ).parent().find( 'input[type="hidden"]' );
